#Cuadrado del mayor y cubo del menor
...
if n1 != n2 : #Comprobar que son distintos N! y N2
    if n1 > n2 : #Comprobar si N1 es mayor
        print('\n------------RESULTADO-------------')
        cua, cub = n1 ** 2, n2 ** 3 #Calcular el cuadrado y cubo de N1 y N2
        print('El número N1 es el mayor con valor: ', n1)
        print('El cuadrado de N1 es: ', cua) #Cuadrado del mayor
        print('El número N2 es el menor con valor: ', n2)
        print('El cubo de N2 es: ', cub) #cubo del menor
    else : #Si N1 no es mayor, entonces N2 es el mayor
        print('\n------------RESULTADO-------------')
        cua, cub = n2 ** 2, n1 ** 3 #Calcular el cuadrado y cubo de N2 y N1
        print('El número N2 es el mayor con valor: ', n2)
        print('El cuadrado de N2 es: ', cua) #Cuadrado del mayor
        print('El número N1 es el menor con valor: ', n1)
        print('El cubo de N1 es: ', cub) #cubo del menor
else :
    print('\n------------RESULTADO-------------')
